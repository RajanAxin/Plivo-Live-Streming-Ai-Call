                ...
                "response": {
                    ...
                    "instructions": (
                        f"Start with this exact phrase: '{audio_message}' "
                         ...
                         #"If the caller confirms the details are correct, first say a short confirmation that the details are confirmed, "
                         #"then immediately call the function update_lead with the confirmed details."
                    )
                }
            }
